...
echo 11. Windows 10 Pro Workstations
echo 12. Windows 10 Pro Workstations N
echo 13. Windows 10 Pro Education
echo 14. Windows 10 Enterprise G
echo 15. Windows 10 Enterprise G N
echo 16. Windows 10 Enterprise LTSC 2019
echo 17. Windows 10 Enterprise N LTSC 2019
echo.
